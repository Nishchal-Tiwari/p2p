...
import {MailIcon,HomeRounded,VideoChatRounded,MessageRounded,SettingsApplicationsRounded,StreamRounded,NetworkCheckRounded,ShareRounded,AccountCircleRounded} from "@mui/icons-material";
           ...
           <Link to={data.link} style={{textDecoration:'none',color:'black'}}>
            <ListItem key={data.name} disablePadding sx={{ display: "block" }}>
              <ListItemButton
                ...
                onClick={() => {index == 4 && setOpenSettings(!openSettings);  }}
              >
                <ListItemIcon
                  sx={{
                    minWidth: 0,
                    ...
                    color:(location.pathname===data.link)?'purple':''
                  }}
                >
